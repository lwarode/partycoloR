...
- **Fast lookups** with bundled party data from Party Facts Wikipedia dataset (100x faster than live scraping)
...
- Automatic fallback to live Wikipedia scraping for parties not in bundled data
