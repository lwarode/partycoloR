...
``` r
# Download the current Partyfacts Wikipedia dataset
...
The Partyfacts data is cached in the R session to avoid repeated
downloads:
...
2.  **Cache Partyfacts data**: If you’ll be doing multiple lookups, call
