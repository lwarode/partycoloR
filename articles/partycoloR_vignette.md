...
The bundled data includes parties from the Party Facts Wikipedia dataset
with available color data. If a party is not in the bundled data,
functions automatically fall back to live Wikipedia scraping.
