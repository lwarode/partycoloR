...
[Partyfacts](https://partyfacts.herokuapp.com/) database integration.
...
The Partyfacts data is cached in the R session to avoid repeated downloads:
...
- [Partyfacts](https://partyfacts.herokuapp.com/) - The source for party identifiers
  and Wikipedia URLs
